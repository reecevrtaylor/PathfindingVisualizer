...
public class Node implements Comparable<Node> {
    ...
    public double setHeuristic(Grid grid) {
        ...
        double euclideanDist = Math.sqrt(Math.pow(xDiff, 2) + Math.pow(yDiff, 2));
        ...
        double randomHeuristic = Math.random() * gridSize;
        ...
        if (GlobalSettings.running) {
            switch (GlobalSettings.heuristic) {
                ...
                case 3 -> heuristicValue = dijkstra;
                case 4 -> heuristicValue = chebyshevDist;
                case 5 -> heuristicValue = randomHeuristic;
            }
        }
    ...
    public LinkedList<Node> getNeighbour(Grid grid) {
        // allows search for neighbours in all 4 directions
        // ROWS + 1
    ...
    public void setEnd(boolean isEndNode) {
        ...
        if (isEndNode) {
            ...
            this.nodeState = NodeState.BLANK;
        }
